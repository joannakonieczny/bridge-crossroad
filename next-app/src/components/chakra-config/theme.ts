...
export const theme = extendTheme({
  ...
  semanticTokens: {
    colors: {
      ...
      neutral: {
        50:  { default: "gray.50",  _dark: "gray.900" },
        100: { default: "gray.100", _dark: "gray.800" },
        200: { default: "gray.200", _dark: "gray.700" },
        300: { default: "gray.300", _dark: "gray.600" },
        400: { default: "gray.400", _dark: "gray.500" },
        500: { default: "gray.500", _dark: "gray.400" },
        600: { default: "gray.600", _dark: "gray.300" },
        700: { default: "gray.700", _dark: "gray.200" },
        800: { default: "gray.800", _dark: "gray.100" },
        900: { default: "gray.900", _dark: "gray.50" },
      },
      fonts: {
        default: "black",
      },
